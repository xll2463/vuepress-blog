...
module.exports = {
    ...
    head: [
        ...
        ['meta', {name: 'Keywords', content: '徐先生,徐先生的主页,bookbook,BookBook,bookbook.cc,BookBook.cc'}],
        // 作者
        ['meta', {name: 'author', content: '徐先生,徐先生的主页,bookbook,BookBook,bookbook.cc,BookBook.cc'}],
        // 百度统计
